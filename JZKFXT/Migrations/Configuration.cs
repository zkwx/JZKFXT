        ...
        protected override void Seed(JZKFXT.DAL.BaseContext db)
        {
            ...
            List<Question> questions1 = new List<Question> {
                ...
                new Question("1-1-1", "希望实现何种功能（多选）", 2,
                    new List<Option>{
                        //02 39 03盲杖
                        new Option("A", "引导出行", "2",0,102390301,102390302,102390303,102390304,102390305,102390306,102390307,102390308,102390309),
                        ...
                        //05 27 06声信号指示器
                        new Option("E", "生活便捷", "2",0, 105270601,105270602,105270603,105270604,105270605,105270606,105270607,105270608,105270609,105270610,105270611,105270612,105270613,105270614,105270615),
                        //03手动式绘画和书写器具；05 12 12手写盲文书写装置；05 12 18特制书写纸（塑膜）
                        new Option("F", "学习书写", "2",0, 105120301,105120302,105120303,105120304,105120305,105120306,105120307, 1051212,105121801),
                    }
                ),
